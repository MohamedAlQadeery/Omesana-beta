...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".logo-header img, .header-archia .logo-header img, .footer-logo img").attr("src", "images/logo-white.png");
		jQuery(".header-transparent .logo-header img").attr("src", "images/logo.png");
		jQuery(".header-full.style1.white .logo-header img").attr("src", "images/logo.png");
		jQuery(".header-archia .logo-header img").attr("src", "images/logo-white.png");
        return false;
    });
   jQuery(".color-skins-db .skin-1").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-1.css");
		jQuery(".logo-header img, .header-archia .logo-header img, .footer-logo img").attr("src", "images/logo-white.png");
		jQuery(".header-transparent .logo-header img").attr("src", "images/logo-1.png");
		jQuery(".header-full.style1.white .logo-header img").attr("src", "images/logo-1.png");
		jQuery(".header-archia .logo-header img").attr("src", "images/logo-white.png");
        return false;
    });
    jQuery(".skin-2").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/color/skin-2.css");
		jQuery(".logo-header img, .header-archia .logo-header img, .footer-logo img").attr("src", "images/logo-white-2.png");
		jQuery(".header-transparent .logo-header img").attr("src", "images/logo-2.png");
		jQuery(".header-full.style1.white .logo-header img").attr("src", "images/logo-2.png");
		jQuery(".header-archia .logo-header img").attr("src", "images/logo-white-2.png");
        return false;
    });
    ...
    jQuery(".skin-3").on('click',function(){
		...
		jQuery(".logo-header img, .header-archia .logo-header img, .footer-logo img").attr("src", "images/logo-white-3.png");
		jQuery(".header-transparent .logo-header img").attr("src", "images/logo-3.png");
		jQuery(".header-full.style1.white .logo-header img").attr("src", "images/logo-3.png");
		jQuery(".header-archia .logo-header img").attr("src", "images/logo-white-3.png");
        return false;
    });
    ...
    jQuery(".skin-4").on('click',function(){
		...
		jQuery(".logo-header img, .header-archia .logo-header img, .footer-logo img").attr("src", "images/logo-white-4.png");
		jQuery(".header-transparent .logo-header img").attr("src", "images/logo-4.png");
		jQuery(".header-full.style1.white .logo-header img").attr("src", "images/logo-4.png");
		jQuery(".header-archia .logo-header img").attr("src", "images/logo-white-4.png");
        return false;
    });
	...
	jQuery('.page-view li ').on('click', function(){
		jQuery('.page-view li ').removeClass('active');
		jQuery(this).addClass('active');
	});
	var currentURL      = window.location.href;
	
	jQuery('.layout-light').on('click',function() { 
	...
	jQuery('.layout-dark').on('click',function() { 
		...
		jQuery(".header-full.style1.white .logo-header img").attr("src", "images/logo-2.png");
		jQuery(".header-archia .logo-header img").attr("src", "images/logo-white-2.png");
		jQuery(".animation-jet img").attr("src", "images/jet-white.png");
		...
		//jQuery(".page-view-css").attr("href", "css/dark.css");
	});
	
	jQuery(window).on('scroll', function () {/*jQuery('link[href*="css/dark.css"]').length > 0  && */
